...
const endtoendArr2 = [
  ...
  },
  {
    ...
    alt: "Trailer & Rail Container Haulage",
  },
];
...
const endtoendArr5 = [
  ...
  },
  {
    ...
    alt: "Tracking & Visibility",
  },
];

const prodArr = [
  {
    heading: "End to End Cross Border Logistics",
    endtoendArr: endtoendArr1,
  },
  {
    heading: "Domestic Logistics",
    endtoendArr: endtoendArr2,
  },
  {
    heading: "Supply Chain Solutions",
    endtoendArr: endtoendArr3,
  },
  {
    heading: "Financial Services",
    endtoendArr: endtoendArr4,
  },
  {
    heading: "Trade Management Solutions",
    endtoendArr: endtoendArr5,
  },
];
          ...
          <div className="our-products-components-container">
            {endtoendArr.map(({ Svg, alt }) => (
              <div className="our-products-component">
                <Svg />
                <div className="our-products-head-container">
                  <h4 className="our-products-head">{alt}</h4>
                </div>
                <div className="our-products-more">
                  <span className="our-products-text">Find Out More </span>
                  <div className="our-products-arrow">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      fill="currentColor"
                      viewBox="0 0 14 14"
